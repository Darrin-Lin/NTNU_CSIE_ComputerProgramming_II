...
static int64_t *Vector_create(size_t size);
static void Vector_free(int64_t *pVector);
static int8_t Vector_push_back(int64_t **pVector, int64_t value, size_t size);
static int8_t Vector_erase(int64_t **pVector, size_t index, size_t size);

static void **Vector_create_ptr(size_t size);
static void Vector_free_ptr(void **pVector);
static int8_t Vector_push_back_ptr(void ***pVector, void *value, size_t size);

static char *Vector_create_char(size_t size);
static int8_t Vector_push_back_char(char **pVector, char value, size_t size);
